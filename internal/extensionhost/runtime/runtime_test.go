...
func TestNewRegistryHasNoBuiltInExtensionTargets(t *testing.T) {
	registry := NewRegistry(nil)

	_, err := registry.Probe("identity-gateway.runtime.health", http.MethodGet, "/extensions/identity-gateway/health", nil)
	require.Error(t, err)
