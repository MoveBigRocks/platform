...
| Operational workflow proof: inbound email, case replies, notifications, and rule-driven delivery | `Open` | [`docs/WORKFLOW_PROOF_MATRIX.md`](./WORKFLOW_PROOF_MATRIX.md), [`internal/service/handlers/postmark_webhooks_integration_test.go`](../internal/service/handlers/postmark_webhooks_integration_test.go), [`internal/service/services/email_service_test.go`](../internal/service/services/email_service_test.go), [`internal/service/handlers/form_event_handler_test.go`](../internal/service/handlers/form_event_handler_test.go), [`internal/automation/services/default_rules_execution_test.go`](../internal/automation/services/default_rules_execution_test.go) | The repo has component and adapter coverage, but it does not yet prove the full worker-backed workflow for `email-commands` and `notification-commands`, and it does not archive machine-readable proof artifacts for those flows. |
| Release, migration, and verification story | `Partially evidenced` | [`docs/testing-strategy.md`](./testing-strategy.md), [`docs/RELEASE_ARTIFACT_CONTRACT.md`](./RELEASE_ARTIFACT_CONTRACT.md), [`migrations/postgres/README.md`](../migrations/postgres/README.md), [`.github/workflows/_build.yml`](../.github/workflows/_build.yml), [`.github/workflows/_test.yml`](../.github/workflows/_test.yml), [`.github/workflows/milestone-proof.yml`](../.github/workflows/milestone-proof.yml), [`docs/MILESTONE_1_PROOF.md`](./MILESTONE_1_PROOF.md), [`docs/CLI_RELEASES.md`](./CLI_RELEASES.md) | CLI release and public-bundle publication evidence are strong, but the integration sweep is still soft-gated and the milestone proof does not yet archive command-driven operational workflow artifacts. |
