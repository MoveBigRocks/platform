...
| Operator-complete case loop: manual create, assign, priority, note, reply, handoff, status, attachment handling | `Open` | [`internal/service/services/case_service.go`](../internal/service/services/case_service.go), [`internal/platform/handlers/workspace_api_handler.go`](../internal/platform/handlers/workspace_api_handler.go), [`docs/AGENT_CLI.md`](./AGENT_CLI.md), [`cmd/mbr/cases.go`](../cmd/mbr/cases.go) | The service layer is richer than the supported CLI and proof surface. Milestone 1 now requires the full case operator loop through supported product surfaces plus workflow proof. |
