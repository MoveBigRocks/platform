...
- a canonical checked-in source in the appropriate first-party extension repo
...
- Enterprise Access: private first-party source in
  `MoveBigRocks/private-extensions/enterprise-access`
...
workflow materializes `extensions`, `private-extensions`, and `extension-sdk`
before it runs that validation. Those sibling repos are pinned in
