...
func (sr *PlatformScenarioRunner) RunUserWorkspaceAssignmentScenario(ctx context.Context) (*ScenarioResult, error) {
	...
	if err := sr.services.Store.Workspaces().CreateWorkspace(ctx, workspace); err != nil {
		return result, fmt.Errorf("create user assignment workspace: %w", err)
	}
...
func (sr *PlatformScenarioRunner) RunRoleBasedAccessScenario(ctx context.Context) (*ScenarioResult, error) {
	...
	if err := sr.services.Store.Workspaces().CreateWorkspace(ctx, workspace); err != nil {
		return result, fmt.Errorf("create RBAC workspace: %w", err)
	}
	...
	if err := sr.services.Store.Users().CreateUser(ctx, owner); err != nil {
		return result, fmt.Errorf("create owner user: %w", err)
	}
	...
	if err := sr.services.Store.Workspaces().CreateUserWorkspaceRole(ctx, ownerRole); err != nil {
		return result, fmt.Errorf("assign owner role: %w", err)
	}

	// Create admin
	admin := platformdomain.NewUser("admin@rbac-test.com", "Workspace Admin")
	if err := sr.services.Store.Users().CreateUser(ctx, admin); err != nil {
	...
	if err := sr.services.Store.Workspaces().CreateUserWorkspaceRole(ctx, adminRole); err != nil {
		return result, fmt.Errorf("assign admin role: %w", err)
	}

	// Create member
	member := platformdomain.NewUser("member@rbac-test.com", "Workspace Member")
	if err := sr.services.Store.Users().CreateUser(ctx, member); err != nil {
		return result, fmt.Errorf("create member user: %w", err)
	}
	...
	if err := sr.services.Store.Workspaces().CreateUserWorkspaceRole(ctx, memberRole); err != nil {
		return result, fmt.Errorf("assign member role: %w", err)
	}

	// Create viewer
	viewer := platformdomain.NewUser("viewer@rbac-test.com", "Workspace Viewer")
	if err := sr.services.Store.Users().CreateUser(ctx, viewer); err != nil {
		return result, fmt.Errorf("create viewer user: %w", err)
	}
	...
	if err := sr.services.Store.Workspaces().CreateUserWorkspaceRole(ctx, viewerRole); err != nil {
		return result, fmt.Errorf("assign viewer role: %w", err)
	}
...
func (sr *PlatformScenarioRunner) RunTeamManagementScenario(ctx context.Context) (*ScenarioResult, error) {
	...
	if err := sr.services.Store.Workspaces().CreateWorkspace(ctx, workspace); err != nil {
		return result, fmt.Errorf("create team workspace: %w", err)
	}

	lead := platformdomain.NewUser("team.lead@team-test.com", "Team Lead")
	if err := sr.services.Store.Users().CreateUser(ctx, lead); err != nil {
		return result, fmt.Errorf("create team lead: %w", err)
	}

	member1 := platformdomain.NewUser("member1@team-test.com", "Team Member 1")
	if err := sr.services.Store.Users().CreateUser(ctx, member1); err != nil {
		return result, fmt.Errorf("create team member1: %w", err)
	}

	member2 := platformdomain.NewUser("member2@team-test.com", "Team Member 2")
	if err := sr.services.Store.Users().CreateUser(ctx, member2); err != nil {
		return result, fmt.Errorf("create team member2: %w", err)
	}
	...
	if err := sr.services.Store.Workspaces().AddTeamMember(ctx, leadMember); err != nil {
		return result, fmt.Errorf("add team lead: %w", err)
	}
	...
	if err := sr.services.Store.Workspaces().AddTeamMember(ctx, teamMember1); err != nil {
		return result, fmt.Errorf("add team member1: %w", err)
	}
	...
	if err := sr.services.Store.Workspaces().AddTeamMember(ctx, teamMember2); err != nil {
		return result, fmt.Errorf("add team member2: %w", err)
	}
...
func (sr *PlatformScenarioRunner) RunContactManagementScenario(ctx context.Context) (*ScenarioResult, error) {
	...
	if err := sr.services.Store.Workspaces().CreateWorkspace(ctx, workspace); err != nil {
		return result, fmt.Errorf("create contact workspace: %w", err)
	}
...
func (sr *PlatformScenarioRunner) RunSessionContextScenario(ctx context.Context) (*ScenarioResult, error) {
	...
	if err := sr.services.Store.Workspaces().CreateWorkspace(ctx, workspace1); err != nil {
		return result, fmt.Errorf("create session workspace 1: %w", err)
	}

	workspace2 := platformdomain.NewWorkspace("Session Workspace 2", "session-ws-2")
	if err := sr.services.Store.Workspaces().CreateWorkspace(ctx, workspace2); err != nil {
		return result, fmt.Errorf("create session workspace 2: %w", err)
	}
	...
	user.IsActive = true
	user.EmailVerified = true
	if err := sr.services.Store.Users().CreateUser(ctx, user); err != nil {
		return result, fmt.Errorf("create multi-workspace user: %w", err)
	}
	...
	if err := sr.services.Store.Workspaces().CreateUserWorkspaceRole(ctx, role1); err != nil {
		return result, fmt.Errorf("assign session role 1: %w", err)
	}
	...
	if err := sr.services.Store.Workspaces().CreateUserWorkspaceRole(ctx, role2); err != nil {
		return result, fmt.Errorf("assign session role 2: %w", err)
	}
