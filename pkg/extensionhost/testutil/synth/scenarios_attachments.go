...
func (sr *AttachmentsScenarioRunner) scenarioAttachmentLifecycle(ctx context.Context, workspaceID string, users []*platformdomain.User) (*ScenarioResult, error) {
	...
	result.Verifications = append(result.Verifications, VerificationResult{
		...
		Details: attachmentDetail(retrieved != nil, func() string {
			return fmt.Sprintf("Filename: %s", retrieved.Filename)
		}),
	})
	...
	result.Verifications = append(result.Verifications, VerificationResult{
		...
		Details: attachmentDetail(retrieved != nil, func() string {
			return fmt.Sprintf("Bucket: %s, Key: %s", retrieved.S3Bucket, retrieved.S3Key)
		}),
	})
	...
	result.Verifications = append(result.Verifications, VerificationResult{
		...
		Details: attachmentDetail(retrieved != nil, func() string {
			return fmt.Sprintf("Status: %s", retrieved.Status)
		}),
	})
...
func (sr *AttachmentsScenarioRunner) scenarioQuarantinedAttachments(ctx context.Context, workspaceID string, users []*platformdomain.User) (*ScenarioResult, error) {
	...
	result.Verifications = append(result.Verifications, VerificationResult{
		...
		Details: attachmentDetail(retrievedClean != nil, func() string {
			return fmt.Sprintf("Status: %s", retrievedClean.Status)
		}),
	})
	...
	result.Verifications = append(result.Verifications, VerificationResult{
		...
		Details: attachmentDetail(retrievedClean != nil, func() string {
			return fmt.Sprintf("ScanResult: %s", retrievedClean.ScanResult)
		}),
	})
	...
	result.Verifications = append(result.Verifications, VerificationResult{
		...
		Details: attachmentDetail(retrievedInfected != nil, func() string {
			return fmt.Sprintf("Status: %s", retrievedInfected.Status)
		}),
	})
	...
	result.Verifications = append(result.Verifications, VerificationResult{
		...
		Details: attachmentDetail(retrievedInfected != nil, func() string {
			return fmt.Sprintf("ScanResult: %s", retrievedInfected.ScanResult)
		}),
	})
	...
	result.Verifications = append(result.Verifications, VerificationResult{
		...
		Details: attachmentDetail(retrievedInfected != nil, func() string {
			return fmt.Sprintf("S3Bucket: %s", retrievedInfected.S3Bucket)
		}),
	})
